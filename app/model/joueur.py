...
class Player:
    ...
    def new_player(self, last_name, first_name, birthdate, club_id):
    ...
    def list_existing_players(cls):
        ...
        for id_ in player_id:
            player_text.append(str(id_) + "\t" + cls.players[id_].last_name + " " + cls.players[id_].first_name)
    ...
    def load_all_players(cls):
        ...
        for player in player_files:
            ...
            cls.players[player_id] = Player(file_path)
